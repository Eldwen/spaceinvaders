...
public class Collision {
	...
	public static boolean collisionParLeBas(Sprite entity1,Sprite entity2) {
		return entity1.ordonneeLaPlusBasse()<=entity2.ordonneeLaPlusHaute() && entity1.ordonneeLaPlusHaute() >=entity2.ordonneeLaPlusHaute();
	}
	public static boolean collisionParLeHaut(Sprite entity1,Sprite entity2) {
		return entity1.ordonneeLaPlusHaute()>=entity2.ordonneeLaPlusBasse() && entity1.ordonneeLaPlusBasse()<=entity2.ordonneeLaPlusBasse();
	}
	public static boolean collisionParlaGauche(Sprite entity1,Sprite entity2) {
		return entity1.abscisseLaPlusADroite()>=entity2.abscisseLaPlusAGauche() && entity1.abscisseLaPlusAGauche()<=entity2.abscisseLaPlusAGauche();
	}
	public static boolean collisionParLaDroite(Sprite entity1,Sprite entity2) {
		return entity1.abscisseLaPlusAGauche()<=entity2.abscisseLaPlusADroite() && entity1.abscisseLaPlusADroite()>=entity2.abscisseLaPlusADroite();
	}
